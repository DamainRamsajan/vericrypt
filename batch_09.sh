...
# DORA axioms
cat > "$CRATE_ROOT/src/compliance/axioms/dora.asl" << 'DORA_ASL'
...
# PQFIF axioms
cat > "$CRATE_ROOT/src/compliance/axioms/pqfif.asl" << 'PQFIF_ASL'
...
# NCSC axioms
cat > "$CRATE_ROOT/src/compliance/axioms/ncsc.asl" << 'NCSC_ASL'
...
# NIST axioms
cat > "$CRATE_ROOT/src/compliance/axioms/nist.asl" << 'NIST_ASL'
...
echo ""
echo "============================================"
echo " Running ASL VM integration tests..."
echo "============================================"

cargo test -p vericrypt --test asl_integration_test
